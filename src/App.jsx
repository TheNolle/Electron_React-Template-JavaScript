...
export default function App() {
    useEffect(() => {
        ...
        links.forEach(link => {
            link.addEventListener('click', async (e) => {
                ...
                if (href) return await window.shell.openExternal(href)
            })
        })
    }, [])
    ...
    return (
        <div className="app-container">
            <header>
                <h1>Electron X React Template</h1>
                <p>Electron and React template with Javascript, Electron, Sass, React Router, and Webpack.</p>
            </header>
            ...
            <main>
                ...
                <Routes>
                    ...
                    <Route path="/N:/" element={<h4>Home</h4>} />
                    <Route path="/N:/Templates/Electron-x-React/dist/index.html" element={<h4>Home</h4>} />
                    <Route path="/versions" element={<Versions />} />
                    <Route path="/N:/versions" element={<Versions />} />
                    <Route path="/user-browser" element={<UserBrowser />} />
                    <Route path="/N:/user-browser" element={<UserBrowser />} />
                    <Route path="/user-browser-version" element={<UserBrowserVersion />} />
                    <Route path="/N:/user-browser-version" element={<UserBrowserVersion />} />
                    <Route path="/user-browser-and-version" element={<><UserBrowser />, <UserBrowserVersion /></>} />
                    <Route path="/N:/user-browser-and-version" element={<><UserBrowser />, <UserBrowserVersion /></>} />
